 ...
 */
	...
	async loadDesktopLight() {
		...
		dayNightInstance.setLampTop(LampTop, lampDefaultMat);
	...
	SwitchModes() {
		...
		let measurementsUI_Desktop = document.getElementById(
			'measurements_Desktop'
		);
          ...
          controls.activate();
			...
			function allowUncheck(e) {
				...
				if (selectedObjects.length != 0) {
					if (
						selectedObjects[0].children[0].children[0].name.slice(0, 5) ==
						'Frame'
					) {
